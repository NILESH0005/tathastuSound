...
export default function AudioInventory() {
    ...
    const brands = Array.from(new Set(audioProducts.map(p => p.brand)));
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="mb-12">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 mt-1">Professional sound systems & microphones</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 bg-white/5 backdrop-blur-md p-4 rounded-2xl border border-white/10">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                type="text"
                                placeholder="Search audio equipment..."
                                value={searchQuery}
                                onChange={(e) => setSearchQuery(e.target.value)}
                                className="w-full pl-10 pr-4 py-2 bg-black/50 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <select
                                ...
                                className="bg-black/50 border border-white/10 rounded-xl px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                            >
                ...
                {filteredProducts.length > 0 ? (
                    ...
                    <div className="text-center py-20 text-gray-500 bg-white/5 rounded-2xl border border-white/10">
                        ...
                        <p className="text-xl">No audio equipment found matching your criteria.</p>
                    </div>
                )}
            </div>
        </div>
